...
<body>
    <div class="users-container">
        ...
        <div class="header-row">
            <div class="header-actions">
                ...
                <button onclick="openAddModal()" class="add-item-icon">
                    ...
                    <c:when test="${empty itemList}">
                        <tr>
                            <td colspan="7" class="empty-state"><i
                                class="fas fa-box-open"></i> No items found</td>
                        </tr>
                    </c:when>
                    <c:otherwise>
                            ...
                            <tr class="item-row">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="add-to-cart-btn" onclick="openQuantityModal('${item.id}')">
    ...
    <div id="itemModal" class="modal">
        <div class="modal-content">
            ...
            <form id="itemForm" class="registration-form" method="POST">
                ...
                <button type="submit" class="btn" id="submitButton">Add Item</button>
            </form>
        </div>
    </div>
    ...
    <div id="quantityModal" class="modal">
        <div class="quantity-modal-content">
            <button class="close-quantity-btn" onclick="closeModal('quantityModal')">&times;</button>
            <h2 class="modal-header">Enter Quantity</h2>
