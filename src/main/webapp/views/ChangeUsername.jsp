...
<body>
	<div class="container">
		<button class="close-btn"
			onclick="window.location.href='${pageContext.request.contextPath}/views/Dashboard.jsp'"
		>×</button>
		<h2>Change Username</h2>
		<%-- Display error message --%>
		<div class="error-message">${errorMessage}</div>
		<form id="usernameForm"
			action="${pageContext.request.contextPath}/user/change-username"
			method="POST"
		>
			...
			<div class="form-group">
				<label for="newUsername">New Username</label> <input type="text"
					id="newUsername" name="newUsername" required class="form-control"
				>
